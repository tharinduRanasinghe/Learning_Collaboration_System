...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		$teacher_name = $_POST['email'];
		$password = $_POST['password'];
		$hashed_password = password_hash($password, PASSWORD_DEFAULT);

		if(!empty($teacher_name) && !empty($password))
		{

			//read from database
			$query = "select * from teacher_db where teacher_id = '$teacher_name'";
...
<head>
    ...
    <title>AUAHA - Teacher Login</title>
    ...
    <div id="login">
        <aside>
            ...
            <form action="" method="post">
                ...
                <div class="text-center add_top_10">New to Auaha? <strong><a href="tr_signup.php">Sign up!</a></strong>
                </div>
            </form>
