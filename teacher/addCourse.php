...
if (isset($_POST['submit'])) {
    ...
    $courseId = $_POST['cid'];
    $courseIcon = addslashes(file_get_contents($_FILES["icon"]["tmp_name"]));
   ...
   // echo "record";
    ...
    if (mysqli_num_rows($result1) > 0) {
        header("Location: courses.php?grade=" . $grade);
        exit();
    } else {

        $query2 = "INSERT INTO Course values('$courseId','$courseName','$subject','$grade','$courseIcon','$tid')";
                ...
                <div class="row">
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="col-md-4">
                            ...
                            <label>Image</label>
                            <input type="file" class="dropzone" name="icon" accept="image/* ">
                        </div>
                </div>
                <div class="col-md-8 add_top_30">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cname" placeholder="Name of the course">
                            </div>
                        </div>
                    </div>
                    <!-- /row-->
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" class="form-control" name="sub" placeholder="Your Subject">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
