            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="addCourse.php">
                        <i class="addButton">+ Add a course </i></a>
                </li>
            </ol>
            ...
            <div class="box_general">
                <div class="list_general">
                    <?php
                       ...
                       $query = "SELECT * FROM course where tid='$tid' AND grade='$grade'";
                       ...
                       if (mysqli_num_rows($result_set) > 0) {
                           ...
                           <li>";
                               ...
                               echo "<a href = 'lessons.php?courseId=".$record['CourseId']."'><h4>" . $record['CourseName'] . "</h4></a>";
                               echo "<ul class = 'course_list'>";
                               echo "<li><strong>Grade " . $record['Grade'] . "</strong> </li>";
                               echo "</ul>";
