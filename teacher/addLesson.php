...
if (isset($_POST["submit"])) {
    ...
    $query1 = "SELECT * FROM lesson WHERE  CourseId='$courseId' AND LessonName='$lessonName'";
    $result1 = mysqli_query($connection, $query1);
    if (mysqli_num_rows($result1) > 0) {
        header("Location: lessons.php?courseId=" . $courseId."&message=".$message);
        exit();
    } else {
        $query2 = "INSERT INTO lesson values('$courseId','$lessonName','$name','$tid')";
        ...
        <div class="container-fluid">
            ...
            <div class="box_general padding_bottom">
                <div class="header_box version_2">
                    <h2><i class="fa fa-user"></i>Lesson details</h2>
                </div>
                <div class="row">
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="col-md-4">
                            ...
                            <input type="file" class="dropzone" name="video" accept="video/*,.mkv">
                        </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cid" placeholder="Id of the course">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Lesson Name</label>
                                <input type="text" class="form-control" name="lname" placeholder="Name of the Lesson">
                            </div>
                        </div>
                    </div>
                    <!-- /row-->

                    <input type="submit" class="btn_1 medium" name="submit" value="Add" />
                </div>
            </div>
            <!-- /.container-fluid-->
