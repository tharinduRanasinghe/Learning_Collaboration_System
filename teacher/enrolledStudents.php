    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <span class="title1" style="margin-left:40%;font-size:30px;"><b>Course Enrollment</b></span><br /><br />
            ...
            <?php
                ...
                $result = mysqli_query($connection,"SELECT * from student_db sd Right outer join  studentcourse sc on sd.sid=sc.Sid inner join course c on sc.CourseId=c.CourseId where c.TId='$tid'") or die('Not loaded');
                echo  '<div class="box_general">
            			<div class="list_general">
                  <div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                <tr><td><b></b></td><td><b>Student Id</b></td><td><b>Student Name</b></td><td><b>Course Id</b></td><td><b>Subject</b></td><td><b>Grade</b></td></tr>';
                $c=1;
                while($row = mysqli_fetch_array($result)) {
                	$sid = $row['Sid'];
                  $sname= $row['student_fname'];
                	$courseId = $row['CourseId'];
                	$sub = $row['Subject'];
                    $grade = $row['Grade'];

                	echo "<tr><td>".$c++."</td><td>".$sid."</td><td>".$sname."</td><td>".$courseId."</td><td>".$sub."</td><td>".$grade."</td>";
