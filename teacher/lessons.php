...
if (isset($_GET['remove'])) {
    ...
    $query1 = "DELETE FROM lesson WHERE  CourseId='$courseId' AND LessonName='$lessonName'";
    $result1 = mysqli_query($connection, $query1);
    if (mysqli_affected_rows($connection)==1) {
        header("Location: lessons.php?courseId=" . $courseId);
        exit();
    } else {
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="addLesson.php">
                        <i class="addButton">+ Add a lesson </i></a>
                </li>
            </ol>
            ...
            <div class="box_general">
                <div class="list_general">
                    <?php
                       ...
                       $query = "SELECT * FROM Lesson where tid='$tid' AND CourseId='$courseId'";
                       ...
                       if ($result_set) {
                           ...
                           <li>";
                                   echo "<figure><img src = '../assets/img/icons/lesson.png' alt = ''></figure>";
                               echo "<a href = 'watch.php?courseId=".$courseId."&lessonName=".$record['LessonName']."'><h4>" . $record['LessonName'] . "</h4></a>";
                               echo "<ul class='buttons'>";
                   						echo 	"<li><a href='lessons.php?remove=remove&courseId=".$courseId."&lessonName=".$record['LessonName']."' class='btn_1 gray delete'><i class='fa fa-fw fa-times-circle-o'></i>Remove</a></li>";
