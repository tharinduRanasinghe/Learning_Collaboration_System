    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="box_general">
                ...
                <form class="form-inline my-2 my-lg-0 mr-lg-2" action="search.php" metghod="GET">
                    <h5>Grade</h5>
                    <div class="input-group">
                        <input class="form-control search-top" type="text" placeholder="Search grade" autocomplete="off"
                            name="search">
