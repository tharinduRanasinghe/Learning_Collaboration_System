        ...
        <div class="container-fluid">
            ...
            <div class="box_general">
                <div class="list_general">
                    ...
                    $query = "SELECT * FROM course AS C,studentcourse AS S WHERE S.Sid='$sid' AND S.Grade=C.Grade AND S.CourseId=C.CourseId";
                       ...
                       if (mysqli_num_rows($result_set) > 0) {
                           ...
                           <li>";
                                   echo "<figure><img src = 'data:image;base64,". base64_encode($record['Image'])."' alt = ''></figure>";
                                    echo "<small>Grade " . $record['Grade'] . " " . $record['Subject'] . "</small>";
                                echo "<h4>" . $record['CourseName'] . "</h4>";
                           
                               
                               echo "<p><a href = 'lessons.php?grade=" . $record['Grade'] . "&courseId=" . $record['CourseId'] . "&courseName=".$record['CourseName']."' class='btn_1 gray'><i class='fa fa-fw fa-eye'></i> View Course </a></p>";
                               echo "<ul class='buttons'>";
				echo "<li><a href='delete.php?sid=".$sid."&grade=".$record['Grade']."&courseId=".$record['CourseId']."' class='btn_1 gray delete'><i class='fa fa-fw fa-times-circle-o'></i> Remove</a></li>";
                                echo " </ul>"; 
